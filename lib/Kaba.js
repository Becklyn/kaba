...
class Kaba
{
    ...
    constructor ()
    {
         ...
         * @type {boolean}
         */
        this.useTypeScriptForJsFiles = false;
     ...
     * @returns {Kaba}
     */
    compileJavaScriptAsTypeScript ()
    {
        this.useTypeScriptForJsFiles = true;
        return this;
    }
    ...
    buildWebpackConfig ()
    {
        ...
        const config = {
            ...
            module: {
                rules: [
                    // Babel is only added if {} is false

                    // TypeScript
                    {
                        test: this.useTypeScriptForJsFiles ? /\.[jt]sx?$/ : /\.tsx?$/,
                        use: [
        ...
        // only compile JS with babel directly, if it shouldn't be compiled with TypeScript
        if (!this.useTypeScriptForJsFiles)
        {
