...
class Kaba
{
    ...
    constructor ()
    {
        ...
        /**
         * don't automatically polyfill certain node libraries as we don't care about these implementations and they just add weight.
         *
         * @private
         * @type {boolean|Object}
         */
        this.nodePolyfillConfiguration = false;
    ...
    /**
     * Configures the Webpack option for `node` Polyfills.
     *
     * See https://webpack.js.org/configuration/node/#node
     *
     * @param {boolean|Object} polyfillConfiguration
     *
     * @return {Kaba}
     */
    configureNodePolyfills (polyfillConfiguration)
    {
        this.nodePolyfillConfiguration = polyfillConfiguration;
        return this;
    }
    ...
    buildWebpackConfig (cliConfig)
    {
        ...
        const config = {
            ...
            // node
            node: this.nodePolyfillConfiguration,
        };
        ...
        if (cliConfig.isBundleAnalyzerEnabled())
        {
            ...
            catch (e)
            {
                ...
                {
                    console.log(kleur.red("You need to manually install the analyzer plugin:"));
                    console.log(kleur.red("    yarn add webpack-bundle-analyzer"));
                }
                else
                {
