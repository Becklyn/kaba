...
class Kaba
{
        ...
        const config = {
            ...
            optimization: {
                ...
                splitChunks: {
                    ...
                    name: (module, chunks) => this.generateChunkName(module, chunks),
                    cacheGroups: {
                        default: {
                            minChunks: 2,
                            priority: -20,
    ...
    /**
     * Callback for generating the chunk name
     *
     * @private
     * @param {{type: string}} module
     * @param {Array<{name: string}>} chunks
     * @return {string}
     */
    generateChunkName (module, chunks)
    {
        let prefix = "out";

        switch (module.type.replace(/\/.*$/, ""))
        {
            case "javascript":
                prefix = "js";
                break;
