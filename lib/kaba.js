...
class Kaba
{
    ...
    /**
     * Enables the bundle visualizer
     *
     * @param {boolean} onlyInDebug
     * @return {Kaba}
     */
    enableBundleVisualizer (onlyInDebug = true)
    {
        if (!onlyInDebug || this.config.isDebug())
        {
            this.plugins.push(new BundleAnalyzerPlugin({
                openAnalyzer: this.config.isDebug(),
            }));
        }
        return this;
    }
