...
class Logger
{
    ...
    {
        this.log(`${kleur.red(message)}: ${error.message}`);
    }
    ...
    {
        this.log(`${kleur.red("Compilation Error")} in file ${kleur.yellow(error.file)} on line ${kleur.yellow(error.line)}:`);
    ...
    log (message)
    {
        console.log(`${kleur.gray(this.getCurrentTime())} ${this.prefix} ${message}`);
    }
